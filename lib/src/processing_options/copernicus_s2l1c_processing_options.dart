...
class CopernicusS2l1cProcessingOptions extends CopernicusProcessingOptions {
  @override
  CopernicusSatillite get satillite => CopernicusSatillite.s2l1c;

  const CopernicusS2l1cProcessingOptions({
    super.upSampling,
    super.downSampling,
  });
  ...
  factory CopernicusS2l1cProcessingOptions.fromMap(Map<String, dynamic> map) {
    ...
    return CopernicusS2l1cProcessingOptions(
